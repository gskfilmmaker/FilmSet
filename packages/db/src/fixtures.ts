...
export const theBandScenes: Scene[] = [
  { id: "scene_40", number: "40", intExt: "INT", setName: "Nasreen's Tea Shop", dayNight: "DAY", synopsis: "Nasreen warns Abraham to stop asking questions.", pageCount: "1 2/8", status: "Shot", shootDayId: "day_16", castIds: ["cast_abraham", "cast_nasreen"], locationId: "loc_nasreens-shop" },
  { id: "scene_41", number: "41", intExt: "INT", setName: "Nasreen's Tea Shop", dayNight: "DAY", synopsis: "Farid confronts Abraham outside the shop.", pageCount: "7/8", status: "Shot", shootDayId: "day_16", castIds: ["cast_abraham", "cast_farid"], locationId: "loc_nasreens-shop" },
  { id: "scene_42", number: "42", intExt: "INT", setName: "Connaught Place Precinct", dayNight: "DAY", synopsis: "Inspector Vaid reviews Aisha's missing person file.", pageCount: "1 1/8", status: "Draft", shootDayId: null, castIds: ["cast_vaid"], locationId: "loc_police-station" },
  { id: "scene_44", number: "44", intExt: "INT", setName: "Abraham's Apartment", dayNight: "NIGHT", synopsis: "Abraham finds a matchbook from Nasreen's shop in Aisha's things.", pageCount: "5/8", status: "Shot", shootDayId: "day_17", castIds: ["cast_abraham"], locationId: "loc_abraham-apartment" },
  { id: "scene_45", number: "45", intExt: "INT", setName: "Abraham's Apartment", dayNight: "NIGHT", synopsis: "Meera arrives with information about Rohan Kapoor's shipments.", pageCount: "2 1/8", status: "Shot", shootDayId: "day_17", castIds: ["cast_abraham", "cast_meera"], locationId: "loc_abraham-apartment" },
  { id: "scene_46", number: "46", intExt: "INT", setName: "Abraham's Apartment", dayNight: "NIGHT", synopsis: "Sunita calls, worried she hasn't heard from Aisha.", pageCount: "6/8", status: "Shot", shootDayId: "day_17", castIds: ["cast_abraham", "cast_sunita"], locationId: "loc_abraham-apartment" },
  { id: "scene_47", number: "47", intExt: "EXT", setName: "Paharganj Street", dayNight: "NIGHT", synopsis: "Abraham arrives looking for Aisha.", pageCount: "2 1/8", status: "Scheduled", shootDayId: "day_18", castIds: ["cast_abraham", "cast_aisha"], locationId: "loc_paharganj-street" },
  { id: "scene_48", number: "48", intExt: "EXT", setName: "Paharganj Street", dayNight: "NIGHT", synopsis: "Aisha explains what she saw the night of the shipment.", pageCount: "1 4/8", status: "Scheduled", shootDayId: "day_18", castIds: ["cast_abraham", "cast_aisha"], locationId: "loc_paharganj-street" },
  { id: "scene_49", number: "49", intExt: "EXT", setName: "Paharganj Street", dayNight: "NIGHT", synopsis: "Karim's men spot them from a passing car.", pageCount: "7/8", status: "Scheduled", shootDayId: "day_18", castIds: ["cast_abraham", "cast_aisha", "cast_karim"], locationId: "loc_paharganj-street" },
  { id: "scene_50", number: "50", intExt: "EXT", setName: "Chandni Chowk Market", dayNight: "DAY", synopsis: "Abraham and Aisha lose the tail in the market crowd.", pageCount: "1 6/8", status: "Scheduled", shootDayId: "day_19", castIds: ["cast_abraham", "cast_aisha"], locationId: "loc_chandni-chowk-market" },
  { id: "scene_51", number: "51", intExt: "EXT", setName: "Chandni Chowk Market", dayNight: "DAY", synopsis: "Inspector Vaid questions market vendors about the chase.", pageCount: "1 1/8", status: "Scheduled", shootDayId: "day_19", castIds: ["cast_vaid"], locationId: "loc_chandni-chowk-market" },
  { id: "scene_52", number: "52", intExt: "EXT", setName: "NH19 Highway to Agra", dayNight: "NIGHT", synopsis: "Deepak's truck convoy makes its run.", pageCount: "2 3/8", status: "Scheduled", shootDayId: "day_20", castIds: ["cast_deepak", "cast_farid"], locationId: "loc_highway-agra" },
  { id: "scene_53", number: "53", intExt: "EXT", setName: "NH19 Highway to Agra", dayNight: "NIGHT", synopsis: "Vaid's unit sets up a checkpoint.", pageCount: "1 3/8", status: "Scheduled", shootDayId: "day_20", castIds: ["cast_vaid"], locationId: "loc_highway-agra" },
  { id: "scene_12", number: "12", intExt: "INT", setName: "Rohan Kapoor's Office", dayNight: "DAY", synopsis: "Rohan pressures a city official over the shipment route.", pageCount: "1 5/8", status: "Draft", shootDayId: null, castIds: ["cast_rohan"], locationId: "loc_studio-a" },
  { id: "scene_13", number: "13", intExt: "INT", setName: "Rohan Kapoor's Office", dayNight: "DAY", synopsis: "Rohan learns Meera is investigating him.", pageCount: "1 2/8", status: "Draft", shootDayId: null, castIds: ["cast_rohan", "cast_meera"], locationId: "loc_studio-a" },
  { id: "scene_30", number: "30", intExt: "INT", setName: "Nasreen's Tea Shop", dayNight: "NIGHT", synopsis: "Cut from the schedule — covered by Scene 40.", pageCount: "4/8", status: "Omitted", shootDayId: null, castIds: ["cast_nasreen"], locationId: "loc_nasreens-shop" },
  { id: "scene_8", number: "8", intExt: "EXT", setName: "Abraham's Apartment Building", dayNight: "DAY", synopsis: "Establishing shot — needs a pickup.", pageCount: "1/8", status: "Pickup", shootDayId: null, castIds: [], locationId: "loc_abraham-apartment" },
];
